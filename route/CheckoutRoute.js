...
//@desc update chekout to mark as paid after successful payment
//@access Private
...
//@desc finalize checkout and convert to an order after payment comformation
//@access privte
router.post("/:id/finalize",protect,async(req,res)=>{
    try{
        ...
        if(!checkout){
            return res.status(404).json({message:"checkout not found error"})
        }
